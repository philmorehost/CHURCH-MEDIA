...
<div class="guide">
  ...
  <div class="card" style="margin-bottom:18px;">
    ...
    <p><strong>Instant password strength:</strong> the register page measures strength on every keystroke — <span style="color:#ff6b6b;">red = weak</span>, <span style="color:#e8b95f;">amber = fair</span>, <span style="color:#5fe0a4;">green = strong</span> — and suggests a stronger password based on what was typed. Weak passwords are <strong>blocked at submission</strong> (12+ chars, 3 of upper/lower/digit/symbol) so cPanel email creation never fails. After submitting, applicants see a <strong>“Submission received”</strong> screen with a <strong>WhatsApp</strong> link (from Settings → Contact Phone) for instant review &amp; approval. Use <strong>Settings → 🔌 Test cPanel connection</strong> to verify your API token, and <strong>✉ Create email</strong> on an approved registration to retry a failed mailbox.</p>
  </div>
