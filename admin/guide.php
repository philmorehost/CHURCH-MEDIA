...
<div class="guide">
  ...
  <div class="card" style="margin-bottom:18px;">
    ...
    <p><strong>Admin &amp; App Only Mode</strong> (same card): optionally redirect <strong>Android phone</strong> visitors to the app to boost adoption. Choose <em>Off</em> (default), a <em>“Get the App” landing page</em> (with a “Continue to website” link), or <em>Force</em> (send straight to the Play link). iPhone and desktop visitors always keep the website, and search engines are never redirected — so SEO is unaffected.</p>
